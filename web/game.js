...
var ASM_CONSTS = {
 ...
 243012: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 243095: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 243164: () => { return window.innerWidth; },  
 243194: () => { return window.innerHeight; }
};
